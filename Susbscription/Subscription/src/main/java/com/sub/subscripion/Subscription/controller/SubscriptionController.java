package com.sub.subscripion.Subscription.controller;
...
public class SubscriptionController {
	...
	public ResponseEntity<SubscriptionResponse> createSubscription(
		...
		SubscriptionResponse subscriptionResponse = subscriptionService.createSubscription(createSubscriptionRequest);
